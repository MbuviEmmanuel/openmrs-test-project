 ...
 */
package org.openmrs.module.openmrstestproject.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.OpenmrstestprojectController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class OpenmrstestprojectController {
